...
const hospitalList = [
  ...
  },
  {
    ...
    setUpTime: "2016年1月",
    address: [
      "深圳市罗湖火车站大楼 C区1-8楼，另有13家口腔门诊部分别设于深圳罗湖，福田，南山及宝安区",
    ],
  ...
  <div class="table">
    <div>
      <div class="table-content">
        <p>
          希玛经过十年深耕，重点建立以大湾区为主的全国性实体医院网路，遍及深圳、北京、上海、广州、昆明及大湾区多个重点城市。希玛的港式高质、安全可靠及价格合理的医疗服务，获得病人正面回馈。在深圳市卫生健康委员会每季度的非公立医院患者满意度评分中，深圳希玛林顺潮眼科医院长期高踞前列位置。
        </p>
      </div>
