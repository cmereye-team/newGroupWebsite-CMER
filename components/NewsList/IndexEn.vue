...
async function fetchData() {
  await fetch("https://www.cmermedical.com/backend/api.php/list/24")
    ...
    .then((res) => {
      ...
      arr.value.map((item: any) => {
        newsListEn.push({
          id: item.id,
          title: item.title,
          ext_uploadFile: item.ext_uploadFile.split("/")[1] == "static"
  ...
  <div class="news">
    <div class="news-title">
      ...
      <div>
        ...
        <div class="title-btn" @click="clear">Clear</div>
