...
let arr = ref([]);
const GovernanceListCn: any = reactive([
  {
    id: 0,
    title: "",
    ext_uploadFile: "",
...
async function fetchData() {
  await fetch("https://www.cmermedical.com/backend/api.php/list/20")
    .then((response) => response.json())
    .then((data) => {
      // 清空数组
      GovernanceListCn.splice(0, GovernanceListCn.length);
      arr.value = data.data;
...
<template>
  <div class="corporate">
    <div class="corporate-container">
      ...
      <div v-for="item in GovernanceListCn" :key="item.id">
